    ...
    <strong>
        Sada Al Anwar Company for Wholesale and Retail Trade / شركة صدى الأنوار لتجارة الجملة والتجزئة
            ...
            <p>{{ bilingual('date', 'التاريخ') }}:
                ...
                @if ($lims_sale_data->table_id && $lims_sale_data->table)
                ...
                <tbody>
                    ...
                    @foreach ($lims_product_sale_data as $key => $product_sale_data)
                        ...
                        @if (isset($show->show_description) && $show->show_description == 1)
                            ...
                            <tr>
                                <td colspan="4" style="text-align:right;vertical-align:bottom;width:50%">
                    ...
                    <!-- <tfoot> -->
                    <tr>
                        <th colspan="2" style="text-align:left">{{ bilingual('Total', 'المجموع') }}</th>
                    ...
                    @if ($lims_sale_data->shipping_cost)
                        <tr>
                            <th colspan="2" style="text-align:left">{{ bilingual('Shipping Cost', 'تكلفة الشحن') }}
                            </th>
                            <th style="text-align:right">
                    ...
                    @endif
                    <tr>
                        <th colspan="2" style="text-align:left">{{ bilingual('grand total', 'المجموع الإجمالي') }}
                        </th>
                        <th style="text-align:right">
                    ...
                    @if ($lims_sale_data->grand_total - $lims_sale_data->paid_amount > 0)
                        <tr>
                            <th colspan="2" style="text-align:left">{{ bilingual('Due', 'المستحق') }}</th>
                            <th style="text-align:right">
