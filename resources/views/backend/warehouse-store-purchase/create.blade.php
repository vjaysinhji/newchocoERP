            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'warehouse-store-purchases.store', 'method' => 'post', 'files' => true, 'id' => 'purchase-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <label>{{__('db.Select Warehouse Store Item')}} <small class="text-muted">({{__('db.Only warehouse store items can be purchased here')}})</small></label>
...
<script type="text/javascript">
    ...
    $("ul#basement #warehouse-store-purchase-create-menu").addClass("active");
