...
<section>
    ...
    <div class="table-responsive">
        <table id="disabled-date-table" class="table" style="width: 100%">
            <thead>
                <tr>
            ...
            <tbody>
                @foreach($disabledDates as $index => $row)
                <tr data-id="{{ $row->id }}">
                    <td></td>
                    <td>{{ $index + 1 }}</td>
                    <td>{{ $row->date }}</td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                {{ Form::open(['route' => ['disabled-dates.destroy', $row->id], 'method' => 'DELETE']) }}
                                <li>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="createModalLabel" class="modal-title">New Date</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
                {!! Form::open(['route' => 'disabled-dates.store', 'method' => 'post']) !!}
                <div class="row">
...
<div id="edit-modal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="editModalLabel" class="modal-title">Edit Date</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
                {!! Form::open(['route' => ['disabled-dates.update', 0], 'method' => 'put', 'id' => 'edit-form']) !!}
                <div class="row">
                    <div class="col-md-12 form-group">
                        <label>Date</label>
...
<script type="text/javascript">
    ...
    $("ul#delivery-operation #disabled-date-menu").addClass("active");
    ...
    $(document).on('click', '.edit-btn', function () {
        var id = $(this).data('id');
        var action = '{{ route('disabled-dates.update', 0) }}';
    ...
    $(document).on('change', '.status-toggle', function () {
        ...
        var url = '{{ route("disabled-dates.inlineStatus", ":id") }}'.replace(':id', id);
    ...
    $(document).on('change', '.sort-order-input', function () {
        ...
        var url = '{{ route("disabled-dates.inlineSort", ":id") }}'.replace(':id', id);
