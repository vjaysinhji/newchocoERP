...
<section>
    ...
    <div class="table-responsive">
        <table id="delivery-time-table" class="table" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                {{ Form::open(['route' => ['delivery-times.destroy', $row->id], 'method' => 'DELETE']) }}
                                <li>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="createModalLabel" class="modal-title">New Time</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
                {!! Form::open(['route' => 'delivery-times.store', 'method' => 'post']) !!}
                <div class="row">
...
<div id="edit-modal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="editModalLabel" class="modal-title">Edit Time</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
                {!! Form::open(['route' => ['delivery-times.update', 0], 'method' => 'put', 'id' => 'edit-form']) !!}
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label>From Time:</label>
                        <input type="time" name="from_time" class="form-control" required>
...
<script type="text/javascript">
    ...
    $("ul#delivery-operation #delivery-time-menu").addClass("active");
    ...
    $(document).on('click', '.edit-btn', function () {
        var id = $(this).data('id');
        var action = '{{ route('delivery-times.update', 0) }}';
    ...
    $(document).on('change', '.status-toggle', function(){
        ...
        var url = '{{ route("delivery-times.inlineStatus", ":id") }}'.replace(':id', id);
    ...
    $(document).on('change', '.sort-order-input', function(){
        ...
        var url = '{{ route("delivery-times.inlineSort", ":id") }}'.replace(':id', id);
