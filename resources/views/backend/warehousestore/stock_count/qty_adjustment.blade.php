                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                	...
                                                	<input type="hidden" class="basement-code" value="{{$code[$key]}}" />
                                                	<input type="hidden" class="basement-id" name="product_id[]" value="{{$basement_id[$key]}}" />
                                                    <input type="hidden" class="basement-code" name="product_code[]" value="{{$code[$key]}}" />
                                                	</td>
                                                	</tr>
                                                	@endforeach
                                                </tbody>
...
for(rowindex  =0; rowindex <= rownumber; rowindex++){
    ...
    $.get('{{ url("warehouse-store-adjustment/getbasement") }}/' + id, function(data) {
        ...
        $.each(basement_code, function(index) {
            ...
            lims_basement_array.push(basement_code[index] + ' (' + basement_name[index] + ')');
        });
    });
