@extends('backend.layout.main') @section('content')
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                        ...
                                        <li class="divider"></li>
                                        {{ Form::open(['route' => ['rawmaterials.brand.destroy', $brand->id], 'method' => 'DELETE']) }}
                                        <li>
    ...
    <div id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['route' => 'rawmaterials.brand.store', 'method' => 'post', 'files' => true]) !!}
    ...
    <div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                {{ Form::open(['route' => ['rawmaterials.brand.update', 1], 'method' => 'PUT', 'files' => true]) }}
                <div class="modal-header">
...
@push('scripts')
    <script type="text/javascript">
        ...
        $("ul#rawmaterial #rawmaterial-brand-menu").addClass("active");
        ...
        $(document).ready(function() {
            $(document).on('click', '.open-EditbrandDialog', function() {
                ...
                var url = "{{ url('rawmaterials/brand') }}/" + id + "/edit";
                ...
                $.get(url, function(data) {
                    ...
                    var updateUrl = "{{ url('rawmaterials/brand') }}/" + (data.id || data['id']);
                    ...
                    action: function(e, dt, node, config) {
                        if (user_verified == '1') {
                            ...
                            if (brand_id.length && confirm("Are you sure want to delete?")) {
                                $.ajax({
                                    type: 'POST',
                                    url: '{{ url("rawmaterials/brand/deletebyselection") }}',
                                    data: {
