<ul id="side-main-menu" class="side-menu list-unstyled d-print-none">
    ...
    @can('sidebar_product')
        <li>
            ...
            <ul id="product" class="collapse list-unstyled ">
                ...
                @endcan
                @can('products-index')
                    <li id="product-single-list-menu"><a
                            href="{{ route('products.single.index') }}">{{ __('db.Single Product List') }}</a></li>
                    <!-- <li id="product-create-single-menu"><a href="{{ route('products.single.create') }}">{{ __('db.Add Single Product') }}</a></li> -->
                    <li id="product-combo-list-menu"><a
                            href="{{ route('products.combo.index') }}">{{ __('db.Combo Product List') }}</a></li>
                    <!-- <li id="product-create-combo-menu"><a href="{{ route('products.combo.create') }}">{{ __('db.Add Combo Product') }}</a></li> -->
                @endcan
                @can('products-add')
                @endcan
                @can('print_barcode')
                    <li id="printBarcode-menu"><a href="{{ route('product.printBarcode') }}">{{ __('db.print_barcode') }}</a>
                    </li>
                @endcan
                @can('adjustment')
        ...
        <li>
            ...
            <ul id="rawmaterial" class="collapse list-unstyled ">
                @can('rawmaterials-index')
                    <li id="rawmaterial-category-menu"><a
                            href="{{ route('rawmaterials.category.index') }}">{{ __('db.category') }}</a></li>
                    <li id="rawmaterial-brand-menu"><a href="{{ route('rawmaterials.brand.index') }}">{{ __('db.Brand') }}</a>
                    </li>
                    <li id="rawmaterial-unit-menu"><a href="{{ route('rawmaterials.unit.index') }}">{{ __('db.Unit') }}</a></li>
                    <li id="rawmaterial-list-menu"><a
                            href="{{ route('rawmaterials.index') }}">{{ __('db.Raw Material List') }}</a>
                    </li>
                @endcan
                ...
                @endcan
                @can('rawmaterials-index')
                    <li id="rawmaterial-adjustment-menu"><a
                            href="{{ route('rawmaterial-adjustment.index') }}">{{ __('db.Adjustment List') }}</a></li>
                @endcan
                @can('rawmaterials-index')
                    <li id="rawmaterial-adjustment-create-menu"><a
                            href="{{ route('rawmaterial-adjustment.create') }}">{{ __('db.Add Adjustment') }}</a></li>
                @endcan
                @can('rawmaterials-index')
                    <li id="rawmaterial-stock-count-menu"><a
                            href="{{ route('rawmaterial-stock-count.index') }}">{{ __('db.Stock Count') }}</a></li>
                @endcan
        ...
        <li>
            ...
            <ul id="coldstorage" class="collapse list-unstyled ">
                @can('coldstorages-index')
                    <li id="coldstorage-list-menu"><a
                            href="{{ route('coldstorages.index') }}">{{ __('db.Cold Storage List') }}</a>
                    </li>
                @endcan
        ...
        <li>
            ...
            <ul id="basement" class="collapse list-unstyled ">
                @can('warehouse-stores-index')
                    <li id="warehouse-store-category-menu"><a
                            href="{{ route('warehouse-stores.category.index') }}">{{ __('db.category') }}</a></li>
                    <li id="warehouse-store-brand-menu"><a
                            href="{{ route('warehouse-stores.brand.index') }}">{{ __('db.Brand') }}</a></li>
                    <li id="warehouse-store-unit-menu"><a
                            href="{{ route('warehouse-stores.unit.index') }}">{{ __('db.Unit') }}</a></li>
                @endcan
                @can('warehouse-stores-index')
                    <li id="basement-list-menu"><a
                            href="{{ route('warehouse-stores.index') }}">{{ __('db.Warehouse Stores List') }}</a>
                    </li>
                @endcan
                {{-- @can('warehouse-stores-add')
                <li id="basement-create-menu"><a href="{{ route('warehouse-stores.create') }}">{{
                        __('db.add_warehouse_store') }}</a></li>
                @endcan --}}
                @can('warehouse-stores-index')
                    <li id="warehouse-store-adjustment-menu"><a
                            href="{{ route('warehouse-store-adjustment.index') }}">{{ __('db.Adjustment List') }}</a></li>
                @endcan
                @can('warehouse-stores-add')
                    <li id="warehouse-store-adjustment-create-menu"><a
                            href="{{ route('warehouse-store-adjustment.create') }}">{{ __('db.Add Adjustment') }}</a></li>
                @endcan
                @can('warehouse-stores-index')
                    <li id="warehouse-store-stock-count-menu"><a
                            href="{{ route('warehouse-store-stock-count.index') }}">{{ __('db.Stock Count') }}</a></li>
                @endcan
                @can('warehouse-store-purchases-index')
                    <li id="warehouse-store-purchase-list-menu"><a
                            href="{{ route('warehouse-store-purchases.index') }}">{{ __('db.Warehouse Store Purchase List') }}</a>
                    </li>
                @endcan
                @can('warehouse-store-purchases-add')
                    <li id="warehouse-store-purchase-create-menu"><a
                            href="{{ route('warehouse-store-purchases.create') }}">{{ __('db.Add Warehouse Store Purchase') }}</a>
                    </li>
                @endcan
            </ul>
        </li>
    ...
    @can('sidebar_sale')
        <li>
            ...
            <ul id="sale" class="collapse list-unstyled ">
                ...
                @endcan
                @can('sales-import')
                    <li id="sale-import-menu"><a href="{{ url('sales/sale_by_csv') }}">{{ __('db.Import Sale By CSV') }}</a>
                    </li>
                @endcan
                @can('packing_slip_challan')
                    <li id="packing-list-menu"><a href="{{ route('packingSlip.index') }}">{{ __('db.Packing Slip List') }}</a>
                    </li>
    ...
    @can('sidebar_sale')
        <li>
            <a href="#delivery-operation" aria-expanded="false" data-toggle="collapse">
                <i class="fa fa-truck"></i> Delivery Operation</a>
            <ul id="delivery-operation" class="collapse list-unstyled">
                <li id="governorate-menu"><a href="{{ route('governorates.index') }}">Governorate/States</a></li>
                <li id="area-menu"><a href="{{ route('areas.index') }}">Area & Cities</a></li>
                <li id="disabled-date-menu"><a href="{{ route('disabled-dates.index') }}">Disable Delivery Date</a></li>
                <li id="delivery-time-menu"><a href="{{ route('delivery-times.index') }}">Delivery Timing</a></li>
                <li id="disabled-pickup-date-menu"><a href="{{ route('disabled-pickup-dates.index') }}">Disable Pick up
                        Date</a></li>
                <li id="pickup-time-menu"><a href="{{ route('pickup-times.index') }}">Pickup Timing</a></li>
            </ul>
        </li>
    @endcan
    @can('sidebar_quotation')
        <li>
            ...
            <ul id="quotation" class="collapse list-unstyled ">
                @can('quotes-index')
                    <li id="quotation-list-menu"><a href="{{ route('quotations.index') }}">{{ __('db.Quotation List') }}</a>
                    </li>
                @endcan
                @can('quotes-add')
                    <li id="quotation-create-menu"><a href="{{ route('quotations.create') }}">{{ __('db.Add Quotation') }}</a>
                    </li>
                @endcan
            </ul>
        </li>
    ...
    @can('sidebar_expense')
        <li>
            ...
            <ul id="expense" class="collapse list-unstyled ">
                <li id="exp-cat-menu"><a href="{{ route('expense_categories.index') }}">{{ __('db.Expense Category') }}</a>
                </li>
                @can('expenses-index')
    ...
    @can('sidebar_accounting')
        <li class="">
            ...
            <ul id="account" class="collapse list-unstyled ">
                ...
                @endcan
                @can('balance-sheet')
                    <li id="balance-sheet-menu"><a href="{{ route('accounts.balancesheet') }}">{{ __('db.Balance Sheet') }}</a>
                    </li>
                @endcan
    ...
    <li>
        ...
        <ul id="setting" class="collapse list-unstyled ">
            ...
            @endif
            @can('invoice_setting')
                <li id="invoice-menu"><a href="{{ route('settings.invoice.index') }}">{{ __('db.Invoice Settings') }}</a>
                </li>
            @endcan
            @can('role_permission')
            ...
            @endcan
            @can('general_setting')
                <li id="general-setting-menu"><a href="{{ route('setting.general') }}">{{ __('db.General Setting') }}</a>
                </li>
            @endcan
            @can('mail_setting')
